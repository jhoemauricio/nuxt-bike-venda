...
<div class="flex justify-center items-center grid grid-cols-2 gap-12">
    ...
    <div class="col-span-2 p-6 flex justify-center mt-12">
            <h1 class="font-sans text-5xl text-white"><b>Sign In</b></h1>
    </div>
            ...
            <div class="">
                <Form @submit="logar" :validation-schema="validarDados">
                    ...
                    <div class="mb-24 columns-2 gap-4 p-2">
                        <div>
                            <p class="font-sans hover:underline hover:underline-offset-4 hover:decoration-zinc-50"><b>Registra-te</b></p>
                        </div>
                        <div>
                    ...
                    <div class="flex justify-center">
                        <button class="w-60 px-4 py-6  bg-pink-500 focus:ring-4 focus:outline-none focus:ring-pink-300 rounded-full text-center dark:bg-pink-600"><p class="text-base font-medium text-white text-4xl">Sign Up</p></button>         
                    </div>
